...
void VoxelWorld::justQueueRerender(BlockCoord coord, uint32_t block) {
            ...
            for(int y = startY; y < startY + chunkHeight; ++y) {
                ...
                if(block != 0) {
                    ...
                    if(block == 23) {
                        ...
                        static std::vector<float> stairUVs = StairInfo::getStairUVs();
                        int direction = BlockInfo::getDirectionBits(flags);
                        ...
                        int index = 0;
                        for(float vert : StairInfo::stairModels[modelIndex]) {
                            float thisvert = 0.0f;
                            if(index == 0){
                                thisvert = vert + coord.x;
                            } else
                        ...
                        uvs.insert(uvs.end(), stairUVs.begin(), stairUVs.end());
                    } else
...
void VoxelWorld::checkAboveHeadThreadFunction() {
